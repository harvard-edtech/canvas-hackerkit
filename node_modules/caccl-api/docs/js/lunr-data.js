window.lunrData = {
  "index": {
    ...
    "documentStore": {
      "store": {
        ...
        "api.course.quiz.html#createEssayQuestion": [
          "add",
          "api.course.quiz#createessayquest",
          "cours",
          "course.quiz#createessayquest",
          "creat",
          "createessayquest",
          "essay",
          "function",
          ...
          "question",
          "quiz",
          "quiz#createessayquest"
        ],
        "api.course.quiz.html#createShortAnswerQuestion": [
          "add",
          "answer",
          "api.course.quiz#createshortanswerquest",
          "cours",
          "course.quiz#createshortanswerquest",
          "creat",
          "createshortanswerquest",
          "function",
          "new",
          "option",
          "promise.&lt;object&gt",
                                                                  ...
                                                                  "e": {
                                                                    ...
                                                                    "s": {
                                                                      ...
                                                                      "t": {
                                                                        "docs": {
                                                                          "api.course.quiz.html#createEssayQuestion": {
                                                                            "ref": "api.course.quiz.html#createEssayQuestion",
                                                                            "tf": 1075
                                                                          }
                                                                        }
                                                                      }
  ...
  "store": {
    ...
    "api.account.html": {
      ...
      "kind": "class",
      "title": "account",
      "longname": "api.account",
      "name": "account",
      "tags": "api.account account",
      "summary": "",
      "description": "Functions for interacting with accounts",
      "body": ""
    },
    "api.course.app.html": {
    ...
    "api.course.quiz.html#createMultipleChoiceQuestion": {
      ...
      "summary": "",
      "description": "Creates a new multiple choice question and adds it to a quiz in a course"
    },
    "api.course.quiz.html#createEssayQuestion": {
      "id": "api.course.quiz.html#createEssayQuestion",
      "kind": "function",
      "title": "createEssayQuestion( options ) → {Promise.&lt;Object&gt;}",
      "longname": "api.course.quiz#createEssayQuestion",
      "name": "createEssayQuestion",
      "tags": "api.course.quiz#createEssayQuestion course.quiz#createEssayQuestion quiz#createEssayQuestion createEssayQuestion",
      "summary": "",
      "description": "Creates a new essay question and adds it to a quiz in a course"
    },
    "api.course.quiz.html#createShortAnswerQuestion": {
      "id": "api.course.quiz.html#createShortAnswerQuestion",
      "kind": "function",
      "title": "createShortAnswerQuestion( options ) → {Promise.&lt;Object&gt;}",
      "longname": "api.course.quiz#createShortAnswerQuestion",
      "name": "createShortAnswerQuestion",
      "tags": "api.course.quiz#createShortAnswerQuestion course.quiz#createShortAnswerQuestion quiz#createShortAnswerQuestion createShortAnswerQuestion",
      "summary": "",
      "description": "Creates a new short answer question and adds it to a quiz in a course"
    },
    "api.course.quiz.html#listSubmissions": {
    ...
    "api.other.html": {
      ...
      "longname": "api.other",
      "name": "other",
      "tags": "api.other other",
      "summary": "",
      "description": "Functions for calling other endpoints not added to our support list of APIs",
      "body": ""
    },
    "api.other.html#endpoint": {
      "id": "api.other.html#endpoint",
      "kind": "function",
      "title": "endpoint( path [, method [, params ] ] ) → {Promise.&lt;Object&gt;}",
      "longname": "api.other#endpoint",
      "name": "endpoint",
      "tags": "api.other#endpoint other#endpoint endpoint",
      "summary": "",
