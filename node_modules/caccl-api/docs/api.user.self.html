...
<body>
	...
	<!-- end:navbar.hbs -->		<div class="page-header">
			<div class="container">
				...
				<h1><span class="name">self</span></h1>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-9 main-content">
						<ol class="breadcrumb">
							...
							<li><a href="list_class.html">Endpoints</a></li>
							<li class="active">self</li>
						</ol>
					<section>
							<dl class="symbol primary">
								<dt class="symbol-title class collapsible-symbol expanded">
			<h2 class="class"><span class="signature-new">new&nbsp;</span><span class="name">self</span><span class="signature-params">()</span><span class="signature-type"></span></h2>
</dt>
<dd class="symbol-details class  collapsible-symbol expanded" style="max-height: 9999px;">
	<div class="symbol-details-inner">
			<div class="callout callout-primary"><h5>Description</h5>		<div class="description">Functions for getting info on current user</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<p class="form-control-static"><a href="User_Self.js.html">User/Self.js</a>, <a href="User_Self.js.html#line-1">line 1</a></p>
								</div>
							</div>
			...
			<h4 id="getProfile" class="function public"><span class="name">getProfile</span><span class="signature-params">()</span><span class="signature-type"> &rarr;&nbsp;{Promise.&lt;Object>}</span></h4>
		</dt>
<dd class="symbol-details function public  collapsible-symbol">
	<div class="symbol-details-inner">
			<div class="callout callout-primary"><h5>Description</h5>		<div class="description">Gets info on the current user</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="form-control-static returns-description">Canvas user object <a href="https://canvas.instructure.com/doc/api/users.html#User">https://canvas.instructure.com/doc/api/users.html#User</a></div>
								</div>
							</div>
					</form>
			</div>			<div class="callout callout-default"><h5>Details</h5>		<form class="form-horizontal details">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
										<p class="form-control-static">Gabriel Abrams</p>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Source</label>
								<div class="col-sm-9">
									<p class="form-control-static"><a href="User_Self.js.html">User/Self.js</a>, <a href="User_Self.js.html#line-20">line 20</a></p>
								</div>
							</div>
											...
											<hr/>
											<dt class="symbol-title function public collapsible-symbol">
			<h4 id="listCourses" class="function public"><span class="name">listCourses</span><span class="signature-params">( <span class="signature-param">options</span>&nbsp;)</span><span class="signature-type"> &rarr;&nbsp;{Promise.&lt;Object>}</span></h4>
		</dt>
<dd class="symbol-details function public  collapsible-symbol">
	<div class="symbol-details-inner">
			<div class="callout callout-primary"><h5>Description</h5>		<div class="description">Gets the list of courses associated with the current user</div>
			...
			<div class="callout callout-success"><h5>Returns</h5>		<form class="form-horizontal returns">
							<div class="form-group">
								<label class="col-sm-3 control-label returns-type"><span class="param-type">Promise.&lt;Object></span></label>
								<div class="col-sm-9">
									<div class="form-control-static returns-description">Canvas course object <a href="https://canvas.instructure.com/doc/api/courses.html#Course">https://canvas.instructure.com/doc/api/courses.html#Course</a></div>
								</div>
							</div>
					</form>
			</div>			<div class="callout callout-default"><h5>Details</h5>		<form class="form-horizontal details">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Source</label>
								<div class="col-sm-9">
									<p class="form-control-static"><a href="User_Self.js.html">User/Self.js</a>, <a href="User_Self.js.html#line-36">line 36</a></p>
								</div>
							</div>
